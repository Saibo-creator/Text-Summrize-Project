...
class DatasetConfig(object):
    def __init__(self, name):
        ...
        if name == 'yelp':
            ...
            # Paths
            self.dir_path = 'datasets/hotel_dataset/'
            ######
            self.reviews_path = 'datasets/hotel_dataset/review.json'
            ...
            self.lm_path ='checkpoints/lm/mlstm/hotel_mask_sing_asp/default_056be728/lm_e9_3.05.pt'#估计再5个epo还可以到3.02
            ...
            self.sum_path = 'checkpoints/sum/train/hotel_mask_sing_asp/batch_size_12-notes_4gpu/sum_e1_sub2.pt'
            ...
            # Paths
            self.dir_path = 'datasets/hotel_mask_asp_0_dataset/'
            ######
            self.reviews_path = 'datasets/hotel_mask_asp_0_dataset/review.json'
            self.businesses_path = 'datasets/hotel_mask_asp_0_dataset/business.json'
            ######
            ...
            # Paths
            self.dir_path = 'datasets/hotel_mask_asp_1_dataset/'
            ######
            self.reviews_path = 'datasets/hotel_mask_asp_1_dataset/review.json'
            self.businesses_path = 'datasets/hotel_mask_asp_1_dataset/business.json'
            ######
            ...
            # Paths
            self.dir_path = 'datasets/hotel_mask_asp_2_dataset/'
            ######
            self.reviews_path = 'datasets/hotel_mask_asp_2_dataset/review.json'
            self.businesses_path = 'datasets/hotel_mask_asp_2_dataset/business.json'
            ######
            ...
            # self.lm_path ='checkpoints/lm/mlstm/hotel_mask_asp_2/default_4a2f5c37/lm_e5_3.73.pt'
            ...
            # Paths
            self.dir_path = 'datasets/hotel_mask_asp_3_dataset/'
            ######
            self.reviews_path = 'datasets/hotel_mask_asp_3_dataset/review.json'
            self.businesses_path = 'datasets/hotel_mask_asp_3_dataset/business.json'
            ######
            ...
            # Paths
            self.dir_path = 'datasets/hotel_mask_asp_4_dataset/'
            ######
            self.reviews_path = 'datasets/hotel_mask_asp_4_dataset/review.json'
            self.businesses_path = 'datasets/hotel_mask_asp_4_dataset/business.json'
            ######
...
class HParams(object):
    def __init__(self):
        ...
        self.tau = 4.0  # temperature for softmax 0.5 by default
        self.g_eps = 1e-10  # Gumbel softmax

        ###############################################
        # SUMMARIZATION MODEL SPECIFIC
        ###############################################
        self.sum_cycle = False  # use cycle loss, by default True, I set maually to False to test supervised model
        self.gold_summ_loss = False  # use the crossentropy between gold summary and generated summary as loss(supervised)
        #TODO
        ...
        self.autoenc_docs = True  # add autoencoding loss, default True, I change it maually to False because Diego and I want to test supervised mode
        ...
        self.true_summary = ''  # calculate rouge w.r.t  true summary
        ...
        self.truncate_ = False # when test summarizer, set True to only select first sentence generated(helpful for highly repetitive case)
