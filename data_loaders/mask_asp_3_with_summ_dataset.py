...
class Hotel_Mask_PytorchDataset(Dataset):
    ...
    def __init__(self,
        ...
        self.ds_conf = DatasetConfig('mask_asp_3_with_summ')  # used for paths
...
class Mask_Asp_3_With_Summ_Dataset(SummReviewDataset):
    """
    Main class for using Hotel dataset
    """
    def __init__(self):
        super(Mask_Asp_3_With_Summ_Dataset, self).__init__()
        self.name = 'mask_asp_3_with_summ'
        self.conf = DatasetConfig('mask_asp_3_with_summ')
...
if __name__ == '__main__':
    ...
    hp = HParams()
    ds = SummDatasetFactory.get('mask_asp_3_with_summ')
