...
class SummarizationModel(nn.Module):
    ...
    def forward(self, docs_ids, labels,
        ...
        if self.hp.length_loss:
            ...
            self.stats['length_loss'] = move_to_cuda(torch.mean(torch.ones(extra['shortness'].shape)-extra['shortness']))#10*[6.4844e-01, 4.2873e-06, 8.9063e-01, 7.0317e-02, 5.4688e-01, 7.1737e-06],
