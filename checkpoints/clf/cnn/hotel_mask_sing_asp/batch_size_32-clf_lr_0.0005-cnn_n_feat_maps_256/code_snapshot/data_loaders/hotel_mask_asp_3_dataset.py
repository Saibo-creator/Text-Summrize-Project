...
class Hotel_Mask_Asp_PytorchDataset(Hotel_Mask_PytorchDataset):
    ...
    def __init__(self,
        ...
        self.ds_conf = DatasetConfig('hotel_mask_asp_3')  # used for paths
...
class Hotel_Mask_Asp_3_Dataset(Hotel_Mask_Dataset):
    """
    Main class for using Hotel dataset
    """
    def __init__(self):
        super(Hotel_Mask_Asp_3_Dataset, self).__init__()
        self.name = 'hotel_mask_asp_3'
...
if __name__ == '__main__':
    ...
    hp = HParams()
    ds = SummDatasetFactory.get('hotel_mask_asp_3')
