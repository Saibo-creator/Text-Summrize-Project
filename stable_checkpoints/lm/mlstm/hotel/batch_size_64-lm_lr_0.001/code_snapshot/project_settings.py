...
class DatasetConfig(object):
    def __init__(self, name):
        ...
        if name == 'yelp':
            ...
            # Trained models
            self.lm_path = 'stable_checkpoints/lm/mlstm/hotel/batch_size_256-lm_lr_0.001/lm_e25_3.08.pt'
            self.clf_path = 'stable_checkpoints/clf/cnn/hotel/batch_size_256-clf_lr_0.0001/' \
                            'clf_e15_l0.7415_a0.7115_d0.0000.pt'
            self.sum_path = 'stable_checkpoints/sum/mlstm/hotel/batch_size_16-notes_both-sum_lr_0.0005-tau_2.0/' \
                            'sum_e1_tot4.14_r1f0.26.pt'
            self.autoenc_path = None
