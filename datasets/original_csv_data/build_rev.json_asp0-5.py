...
def export_aspect_n(aspect: int,test,train,dev):
    aspect_nm = 'aspect '+str(aspect)
    test = test[test['hotel_url'].str.startswith(aspect_nm)]
    train = train[train['hotel_url'].str.startswith(aspect_nm)]
    dev = dev[dev['hotel_url'].str.startswith(aspect_nm)]
    ...
    dataset_path = '../hotel_mask_asp_{0}_dataset/'.format(aspect)
...
if __name__ == '__main__':
 ...
 #    train=train[train['hotel_url'].str.startswith('aspect 0')]
 #    dev=dev[dev['hotel_url'].str.startswith('aspect 0')]
